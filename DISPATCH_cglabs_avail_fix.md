...
> - **R/3.1 ⚠️ likely BUG**: `3.1_season_weightings.R` computes value_adj but appears to have NO `write_parquet` (loop ends ~L226) — if season-weighted hazard_exposure is a live product, VERIFY/fix before relying on it to carry the NDWS fix.
