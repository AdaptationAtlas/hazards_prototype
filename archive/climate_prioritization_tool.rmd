...
crop_choice<-"generic" # this will need to become dynamic
...
Thresholds<-reactive({
  ...
  Thresholds<-haz_class[description!="No significant stress" & crop=crop_choice,list(index_name,description,direction,threshold)]
